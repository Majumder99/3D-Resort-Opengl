...
public:
    ...
    glm::vec3 diffuse;
    glm::vec3 specular;
    glm::vec3 translation = glm::vec3(5.0, 1.0, 10.0);
    glm::vec3 scale = glm::vec3(0.3, 0.3, .3);

    float shininess;
    // ctor/dtor
    Sphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(.9f, 0.7f, 0.1f), glm::vec3 diff = glm::vec3(.9f, 0.7f, 0.1f), glm::vec3 spec = glm::vec3(0.9f, 0.5f, 0.5f), float shiny = 2.0f) : verticesStride(24)
    {
    ...
    void drawSphere(Shader& lightingShader, glm::mat4 moveMatrix,  glm::vec3 pivot1, glm::mat4 translateMatrix,
        glm::mat4 translateToPivot, glm::mat4 translateFromPivot, glm::mat4 rotateXMatrix) const      // draw surface
    {
        glm::mat4 identityMatrix = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first
        glm::mat4 scaleMatrix, model;
        
 
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(.2, 0.2, 0.2));
        model = translateFromPivot * rotateXMatrix * translateToPivot * scaleMatrix;
